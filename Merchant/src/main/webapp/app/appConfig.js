 ...
 function config($stateProvider, $urlRouterProvider, $locationProvider, $translateProvider) {
    ...
    $locationProvider.html5Mode(true); 
        ...
        var eng =
        {
            ...
            homeInfo : "Home/apartment informatons",
            address: "Address",
            homeOwnerFN : "Home/apartment owner first name",
            homeOwnerLN : "Home/apartment owner last name",
            homeOwnerJMBG : "Home/apartment owner identification number",
            surface : "Surface of home/apartment",
            selectSurface : "-Select surface-",
            ageOfHome : "Age of apartment,home",
            estimatedValue : "Estimated value of home/apartment",
